...
public class B_Generateur_ANFR_Diff_1p_sup {
    ...
    private final String JS_FILENAME = "diff.js";
    ...
    private void generateur() {
        if (checkBases()) {
            ...
            writeFile(JS_FILENAME,"//Generated by eNB Analytica™");
    ...
    protected void writeMultiPlmn(int ajout, int anfrId) {
        ...
        try {
            ...
            writeFile(JS_FILENAME,"[" + lat + ", " + lon + ", " + 99999 +", "+anfrId + ", \"" + anfrData + "\", \""+ systDecl  + "\", \""+ systActi + "\", "+ajout+"],");
            rs0.close();
        } catch (SQLException e) {
            e.printStackTrace();
        }
